    ...
    <div class="hero-inner">
      <div>
        ...
        <p class="hero-sub anim anim-3">
          <strong>VA, FHA, Conventional, Jumbo &amp; Physician loans</strong> for Texas homebuyers and professionals.
          Killeen · Houston · Dallas-Fort Worth · San Antonio · El Paso · Round Rock · Georgetown.
        ...
        <div class="hero-trust anim anim-5" role="list" aria-label="Trust signals">
          ...
          <span class="trust-item" role="listitem">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" aria-hidden="true"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
            VA-Approved Lender
          </span>
          <span class="trust-divider" aria-hidden="true">·</span>
          <span class="trust-item" role="listitem">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
            21-Day Closings
          </span>
          <span class="trust-divider" aria-hidden="true">·</span>
          <span class="trust-item" role="listitem">
            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" aria-hidden="true"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><circle cx="12" cy="11" r="3"/></svg>
            Texas Statewide
          </span>
        </div>
      </div>
    ...
    <div class="broker-inner">
      <div class="broker-photo-wrap">
        <img
          ...
          alt="Mortgage broker — Unfiltered Keys, Texas"
          class="broker-photo"
          loading="lazy"
        >
...
<section class="section section-slate" aria-labelledby="cities-heading">
  <div class="container">
    ...
    <div class="cities-grid cities-grid-wide" role="list">
      ...
      <!-- ── CENTRAL TEXAS ── -->
      <div class="city-region-label" aria-hidden="true">Central Texas</div>
      <a href="/killeen-mortgage-broker/" class="city-card military" role="listitem" aria-label="Killeen mortgage information">
        <div class="city-card-flag" aria-hidden="true">🎖️</div>
        <div class="city-card-name">Killeen</div>
        <div class="city-card-price">~$225K median</div>
        <div class="city-card-note">Fort Hood gateway. VA loan capital. Bell County.</div>
        <span class="city-card-tag">VA · Military</span>
      </a>
      <a href="/temple-tx-mortgage-broker/" class="city-card medical" role="listitem" aria-label="Temple mortgage information">
        <div class="city-card-flag" aria-hidden="true">🏥</div>
        <div class="city-card-name">Temple</div>
        <div class="city-card-price">~$261K median</div>
        <div class="city-card-note">Baylor Scott &amp; White hub. 13% below national cost of living.</div>
        <span class="city-card-tag">Medical · Relocation</span>
      </a>
      <a href="/copperas-cove-mortgage-broker/" class="city-card military" role="listitem" aria-label="Copperas Cove mortgage information">
        <div class="city-card-flag" aria-hidden="true">🏡</div>
        <div class="city-card-name">Copperas Cove</div>
        <div class="city-card-price">~$245K median</div>
        <div class="city-card-note">Most affordable in the corridor. West gate proximity.</div>
        <span class="city-card-tag">VA · Affordable</span>
      </a>
      <a href="/round-rock-tx-mortgage-broker/" class="city-card tech" role="listitem" aria-label="Round Rock mortgage information">
        <div class="city-card-flag" aria-hidden="true">💻</div>
        <div class="city-card-name">Round Rock</div>
        <div class="city-card-price">~$390K median</div>
        <div class="city-card-note">Dell HQ. Round Rock ISD. 29% below Austin prices.</div>
        <span class="city-card-tag">Tech · Families</span>
      </a>
      <a href="/georgetown-tx-mortgage-broker/" class="city-card growth" role="listitem" aria-label="Georgetown mortgage information">
        <div class="city-card-flag" aria-hidden="true">🚀</div>
        <div class="city-card-name">Georgetown</div>
        <div class="city-card-price">~$405K median</div>
        <div class="city-card-note">Fastest-growing Texas city. Wolf Ranch, Sun City, new construction.</div>
        <span class="city-card-tag">Growth · New Build</span>
      </a>

      <!-- ── MAJOR METROS ── -->
      <div class="city-region-label" aria-hidden="true">Major Metros</div>
      <a href="/houston-mortgage-broker/" class="city-card medical" role="listitem" aria-label="Houston mortgage information">
        <div class="city-card-flag" aria-hidden="true">🏙️</div>
        <div class="city-card-name">Houston</div>
        <div class="city-card-price">~$310K median</div>
        <div class="city-card-note">Texas Medical Center. Nation's largest med complex. Physician loan hub.</div>
        <span class="city-card-tag">Medical · Physician</span>
      </a>
      <a href="/dallas-fort-worth-mortgage-broker/" class="city-card tech" role="listitem" aria-label="Dallas-Fort Worth mortgage information">
        <div class="city-card-flag" aria-hidden="true">🌆</div>
        <div class="city-card-name">Dallas–Fort Worth</div>
        <div class="city-card-price">~$370K median</div>
        <div class="city-card-note">NAS Fort Worth JRB. Corporate relocation corridor. Tech &amp; finance hub.</div>
        <span class="city-card-tag">Military · Tech · Relocation</span>
      </a>
      <a href="/san-antonio-mortgage-broker/" class="city-card military" role="listitem" aria-label="San Antonio mortgage information">
        <div class="city-card-flag" aria-hidden="true">⭐</div>
        <div class="city-card-name">San Antonio</div>
        <div class="city-card-price">~$270K median</div>
        <div class="city-card-note">Joint Base San Antonio. Fort Sam Houston. SAMMC physicians.</div>
        <span class="city-card-tag">VA · Military · Medical</span>
      </a>
      <a href="/el-paso-mortgage-broker/" class="city-card military" role="listitem" aria-label="El Paso mortgage information">
        <div class="city-card-flag" aria-hidden="true">🏜️</div>
        <div class="city-card-name">El Paso</div>
        <div class="city-card-price">~$215K median</div>
        <div class="city-card-note">Fort Bliss. Most affordable Texas major city. VA loan stronghold.</div>
        <span class="city-card-tag">VA · Fort Bliss</span>
      </a>
